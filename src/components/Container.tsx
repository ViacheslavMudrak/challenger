...
const DefaultContainer = (props: ComponentProps): React.JSX.Element => {
  ...
  if (backgroundImage) {
    const prefix = `${!sitecoreContext.mode?.isNormal ? '/sitecore/shell' : ''}/-/media/`;
  ...
  return (
    <div className={`component container-default container ${styles}`} id={id ? id : undefined}>
