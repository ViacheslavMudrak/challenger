...
import CardInfoMockedData1 from '../mocks/card.info10_1.json';
import CardInfoMockedData2 from '../mocks/card.info10_2.json';
import CardInfoMockedData3 from '../mocks/card.info10_3.json';
...
Default.storyName = 'Article card | Type 2';
