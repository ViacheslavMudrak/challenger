...
import CardInfoMockedData1 from '../mocks/card.info11_1.json';
import CardInfoMockedData2 from '../mocks/card.info11_2.json';
...
Default.storyName = 'Landscape text card with shards';
