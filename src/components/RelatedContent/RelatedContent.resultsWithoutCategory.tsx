...
const RelatedContentResultsWidgetWithoutCategory = widget(
  RelatedContentResults,
  WidgetDataType.SEARCH_RESULTS,
  'content'
);

export default RelatedContentResultsWidgetWithoutCategory;
