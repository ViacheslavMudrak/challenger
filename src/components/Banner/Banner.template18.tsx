...
const BannerTemplate18 = (props: BannerComponentProps) => {
    ...
    >
      <div
        className={classNames(
          'relative z-30 h-[30px] w-full md:hidden',
          { hidden: true },
      ...
      <div
        className={classNames(
          'sm:clip-path-polygon-[0_12%,100%_0,100%_100%,0_100%]',
          '-top-px lg:top-0',
      ...
      <div className="relative z-20 min-h-[410px] w-full md:h-[680px] md:w-6/12 md:flex-row md:bg-transparent">
        ...
        <div
          className={classNames(
            'bg-bright-navy clip-path-polygon-[0_0,0%_100%,20%_100%]',
            'absolute z-40 hidden h-full w-full sm:-left-px sm:flex'
          )}
        ></div>
        <div
          className={classNames(
        ...
        <BannerComponentImage
          className={classNames(
            'clip-path-polygon-[0_0,100%_13%,100%_86%,0%_100%] sm:clip-path-polygon-[0_0,100%_8%,100%_90%,100%_100%,0_100%]'
          )}
          image={BannerImage}
        />
      </div>
...
export default BannerTemplate18;
